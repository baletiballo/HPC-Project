...
class FullyConnectedLayer {
	...
	/*static const int packetSize		= (num_classes * num_lastLayer_inputNeurons) / num_packets; //groesse der arbeitspakete
	 static const bool needCleanup	= (num_classes * num_lastLayer_inputNeurons) % num_packets != 0; //soll JobCleanup aufgerufen werden?*/
...
public:
	...
	//void backprop_par(float loss_gradientP [num_classes]);
